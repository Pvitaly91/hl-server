...
bool SaveProjectDocumentToFile(const ProjectDocument& document, const std::wstring& path, std::wstring& errorMessage) {
    ...
    SetString(shotgun, L"sv_exp_shotgun_primary_shot_growth", document.shotgun.primaryShotGrowth);
    SetBool(shotgun, L"sv_exp_shotgun_pattern_mode", document.shotgun.patternMode);
    SetString(shotgun, L"sv_exp_shotgun_pattern_scale_x", document.shotgun.patternScaleX);
    SetString(shotgun, L"sv_exp_shotgun_pattern_scale_y", document.shotgun.patternScaleY);
    SetString(shotgun, L"sv_exp_shotgun_pattern_reset_time", document.shotgun.patternResetTime);
    SetString(shotgun, L"sv_exp_shotgun_pattern_max_index", document.shotgun.patternMaxIndex);
    SetString(shotgun, L"sv_exp_shotgun_primary_pellet_spread_mode", document.shotgun.primaryPelletSpreadMode);
...
bool LoadProjectDocumentFromFile(const std::wstring& path, ProjectDocument& document, std::wstring& errorMessage) {
    ...
    if (const JsonValue::Object* shotgun = FindObject(rootObject, L"shotgun")) {
        ...
        loaded.shotgun.primaryShotGrowth = ReadStringValue(*shotgun, L"sv_exp_shotgun_primary_shot_growth", loaded.shotgun.primaryShotGrowth);
        loaded.shotgun.patternMode = ReadBoolValue(*shotgun, L"sv_exp_shotgun_pattern_mode", loaded.shotgun.patternMode);
        loaded.shotgun.patternScaleX = ReadStringValue(*shotgun, L"sv_exp_shotgun_pattern_scale_x", loaded.shotgun.patternScaleX);
        loaded.shotgun.patternScaleY = ReadStringValue(*shotgun, L"sv_exp_shotgun_pattern_scale_y", loaded.shotgun.patternScaleY);
        loaded.shotgun.patternResetTime = ReadStringValue(*shotgun, L"sv_exp_shotgun_pattern_reset_time", loaded.shotgun.patternResetTime);
        loaded.shotgun.patternMaxIndex = ReadStringValue(*shotgun, L"sv_exp_shotgun_pattern_max_index", loaded.shotgun.patternMaxIndex);
        loaded.shotgun.primaryPelletSpreadMode = ReadStringValue(*shotgun, L"sv_exp_shotgun_primary_pellet_spread_mode", loaded.shotgun.primaryPelletSpreadMode);
